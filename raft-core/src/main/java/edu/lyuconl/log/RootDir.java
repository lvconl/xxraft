...
public class RootDir {
    ...
    RootDir(File baseDir) {
        if (!baseDir.exists()) {
            throw new IllegalArgumentException("dir: " + baseDir + " not exist");
        }
    ...
    LogDir rename(LogDir dir, int lastIncludedIndex) {
        ...
        if (destDir.exists()) {
            throw new IllegalArgumentException("failed to rename, dest dir " + destDir + " exists");
        }
